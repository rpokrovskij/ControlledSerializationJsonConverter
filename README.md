...
`ControlledSerializationJsonConverter` extentds JavaScriptConverter (from `System.Web.Extensions` assembly) with number of powerful parameters to avoid circular references during serialization and to improve json formatting. 
